...
public class CollectionTest extends TestCase {
	...
	final VisitService<Student> mService = VisitService.newService();
	List<Student> mStus;

	@Override
	protected void setUp() throws Exception {
		mService.view(mStus = createStudent(6));
	}
	...
	public void testComposeVisitUpdate(){
		...
		VisitService.newService(list).update(new Student2("new_stu"),
				"testComposeVisit_1", Visitors.truePredicateVisitor())
		.visitAll("testComposeVisit_2", new LogVisitor());
